...
from articles.api.apicontroller import user_controller, role_controller, slang_comment_controller, post_controller
from articles.api.apicontroller import comment_controller, auth_controller, slang_controller
...
@api.doc('Create Roles for articles')
class Comments(Resource):
    """Role Create"""
