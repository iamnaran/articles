...
from app import db
from app.models.SlangWord import SlangWord
from app.models.SlangWord import slang_word_schema, slang_words_schema
from app.models.SlangWordUpVote import SlangWordUpVote, slang_upvote_schema
