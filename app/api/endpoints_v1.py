...
from app.api.apicontroller import user_controller, role_controller, slang_comment_controller, post_controller
from app.api.apicontroller import comment_controller, auth_controller, slang_controller
...
ns = api.namespace("app", description="Articles operations")
...
@api.doc('Create Comment for app')
